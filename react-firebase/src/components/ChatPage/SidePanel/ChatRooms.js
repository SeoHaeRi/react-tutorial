...
export class ChatRooms extends Component {
  ...
  AddChatRoomsListeners = () => {
    ...
    this.state.chatRoomsRef.on("child_added", (DataSnapshot) => {
      ...
      this.addNotificationListener(DataSnapshot.key); // chatRoom의 id전달
    });
  };
  ...
  handleNotification = (
    ...
    // 이미 notifications state 안에 알림 정보가 들어있는 채팅방과 그렇지 않은 채팅방(막 생성시)을 나눠주기
    ...
    if (index === -1) {
      ...
      if (chatRoomId !== currentChatRoomId) {
        ...
        //count 구하기(총 메시지 개수 - 이전에 확인한 메시지 개수)
    ...
    //목표 : 방 하나 하나에 맞는 알림 정보를 notifications state에 넣어주기
      ...
      <li
        ...
        style={{
          backgroundColor:
            ...
            // this.props.chatRoom.id === room.id &&
...
//state에 들은 내용을 컴포넌트 안에서 props로 사용하겠다
